...
# 💫 About Me:
🔭 I’m currently building secure and scalable full-stack applications using the MERN stack and Next.js.<br><br>
🌱 I’m currently learning Next.js to build server-side rendered applications, and diving deeper into advanced Data Structures & Algorithms.<br><br>
👯 I’m looking to collaborate on open-source projects that solve real-world problems.<br><br>
💬 Ask me about: C, Java, Python, HTML, CSS, JavaScript, Tailwind, React.js, Node.js, Express.js, MongoDB, Next.js, Django, Spring Boot, DSA, DBMS, OS, CN, OOP, AI-ML, Data-Science and More...<br><br>
⚡ Fun fact: My passion for learning means I can go from zero to building a functional prototype in a new technology over a weekend.<br>
